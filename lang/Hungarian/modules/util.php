...
define('OGP_LANG_amx_mod_admins', "AMX mod X Adminisztrátorok");
define('OGP_LANG_amx_login_type', "Bejelentkezés típusa");
define('OGP_LANG_amx_login_steamid', "Steam ID");
define('OGP_LANG_amx_login_nick_pass', "Becenév + Jelszó");
define('OGP_LANG_nickname', "Becenév");
define('OGP_LANG_amx_mod_perms', "AMX mod X engedélyek:");
define('OGP_LANG_amx_mod_perm_root', "AMX mod X összes jelölő.");
define('OGP_LANG_amx_mod_perm_custom', "AMX mod X egyéni jelölő.");
define('OGP_LANG_amx_mod_flag_a', "immunitás (más parancsokkal nem lehet kirúgni/letiltani/megölni/verni és befolyásolni őket)");
define('OGP_LANG_amx_mod_flag_b', "foglalás (csatlakozhat fenntartott slotokhoz)");
define('OGP_LANG_amx_mod_flag_c', "mx_kick parancs");
define('OGP_LANG_amx_mod_flag_d', "amx_ban és amx_unban commands parancs");
define('OGP_LANG_amx_mod_flag_e', "mx_slay és amx_slap parancs");
define('OGP_LANG_amx_mod_flag_f', "amx_map parancs");
define('OGP_LANG_amx_mod_flag_g', "amx_cvar parancs (nem minden c változó lesz elérhető)");
define('OGP_LANG_amx_mod_flag_h', "amx_cfg parancs");
define('OGP_LANG_amx_mod_flag_i', "amx_chat and más csevegő parancs");
define('OGP_LANG_amx_mod_flag_j', "amx_vote and más szavazás parancs");
define('OGP_LANG_amx_mod_flag_k', "hozzáférés az sv_password cvarhoz (amx_cvar paranccsal)");
define('OGP_LANG_amx_mod_flag_l', "hozzáférés az amx_rcon és az rcon_password cvar parancshoz (amx_cvar paranccsal)");
define('OGP_LANG_amx_mod_flag_m', "egyéni szint A (további beépülő modulokhoz)");
define('OGP_LANG_amx_mod_flag_n', "egyéni szint B");
define('OGP_LANG_amx_mod_flag_o', "egyéni szint C");
define('OGP_LANG_amx_mod_flag_p', "egyéni szint D");
define('OGP_LANG_amx_mod_flag_q', "egyéni szint E");
define('OGP_LANG_amx_mod_flag_r', "egyéni szint F");
define('OGP_LANG_amx_mod_flag_s', "egyéni szint G");
define('OGP_LANG_amx_mod_flag_t', "egyéni szint H");
define('OGP_LANG_amx_mod_flag_u', "menü elérés");
?>